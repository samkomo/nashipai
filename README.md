...
< PROJECT ROOT >
   ...
   |    |
   |    |-- trading/                        # Handles trading routes and data retrieval
   |    |    |-- routes.py                  # Define trading routes
   ...
   |    |         |-- index.html            # Trading dashboard page
   |    |         |-- *.html                # All other trading-related pages
   |    |    
